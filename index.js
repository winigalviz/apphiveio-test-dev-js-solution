...
const useState = (initialState) => {
  ...
  const getValue = () => stateStack[initialState] !== undefined ? stateStack[initialState] : initialState

  const setter = (toSetValue) => {
    if (typeof toSetValue === 'function') stateStack[initialState] = toSetValue(getValue())
    else stateStack[initialState] = toSetValue
  }
